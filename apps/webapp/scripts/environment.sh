...
### COMMON
echo export JSON_SECRET=3xQftRWq,~-8g>d[FjVLJsXDuAYt.w:
...
### Auth service
echo export AUTH_SERVICE_HOST=https://dev.auth.webapp.${CLOUD_COMPUTER_HOST_DNS}
...
echo export GOOGLE_CALLBACK=https://dev.auth.webapp.${CLOUD_COMPUTER_HOST_DNS}/auth/google/callback
echo export GOOGLE_REDIRECT=https://dev.auth.webapp.${CLOUD_COMPUTER_HOST_DNS}/auth/google
...
echo export GITHUB_CALLBACK=https://dev.auth.webapp.${CLOUD_COMPUTER_HOST_DNS}/auth/github/callback
echo export GITHUB_REDIRECT=https://dev.auth.webapp.${CLOUD_COMPUTER_HOST_DNS}/auth/github
...
### React
echo export REACT_APP=https://dev.client.webapp.${CLOUD_COMPUTER_HOST_DNS}
echo export REACT_APP_HOST=https://dev.hasura.webapp.${CLOUD_COMPUTER_HOST_DNS}/v1alpha1/graphql
echo export REACT_APP_WEBSOCKET_HOST=wss://dev.hasura.webapp.${CLOUD_COMPUTER_HOST_DNS}/v1alpha1/graphql
