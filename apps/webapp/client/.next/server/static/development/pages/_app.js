...
function create(initialState) {
  ...
  const httpLink = new apollo_boost__WEBPACK_IMPORTED_MODULE_1__["HttpLink"]({
    uri: `${"https://dev.hasura.webapp.jackson.cloud-computer.dev/v1alpha1/graphql"}`
  });
  const errorLink = Object(apollo_link_error__WEBPACK_IMPORTED_MODULE_4__["onError"])(({
    ...
    if (graphQLErrors) {
      ...
      if (noAuthentication) {
        return next_dist_client_router__WEBPACK_IMPORTED_MODULE_8___default.a.push(`/login`);
      }
    }
  ...
  const authLink = Object(apollo_link_context__WEBPACK_IMPORTED_MODULE_7__["setContext"])((_, {
    ...
    const token = localStorage.getItem(_constants__WEBPACK_IMPORTED_MODULE_9__["AUTH_TOKEN"]);

    let baseHeaders = Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_0__["default"])({}, headers); // Check if there is a token
...
/* harmony default export */ __webpack_exports__["default"] = (App => {
  ...
  return _temp = _class = class Apollo extends react__WEBPACK_IMPORTED_MODULE_3___default.a.Component {
    static async getInitialProps(ctx) {
      ...
      const apollo = Object(_init_apollo__WEBPACK_IMPORTED_MODULE_6__["default"])();

      if (true) {
        try {
          // Run all GraphQL queries
          await Object(react_apollo__WEBPACK_IMPORTED_MODULE_5__["getDataFromTree"])(react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(App, Object(_babel_runtime_corejs2_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_1__["default"])({}, appProps, {
            Component: Component,
            router: router,
            apolloClient: apollo,
            __source: {
    ...
    constructor(props) {
      super(props);
      this.apolloClient = Object(_init_apollo__WEBPACK_IMPORTED_MODULE_6__["default"])(props.apolloState);
    }
...
/* harmony import */ var _lib_with_apollo_client__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../lib/with-apollo-client */ "./lib/with-apollo-client.js");

var _jsxFileName = "/cloud-computer/cloud-computer/apps/webapp/client/pages/_app.js";
...
/* harmony default export */ __webpack_exports__["default"] = (Object(_lib_with_apollo_client__WEBPACK_IMPORTED_MODULE_5__["default"])(MyApp));
