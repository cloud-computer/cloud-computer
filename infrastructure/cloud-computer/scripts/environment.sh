...
echo export CLOUD_COMPUTER_KUBERNETES=/cloud-computer/kubernetes
...
echo export CLOUD_COMPUTER_KUBERNETES_VOLUME="${COMPOSE_PROJECT_NAME}_CLOUD_COMPUTER_KUBERNETES"
