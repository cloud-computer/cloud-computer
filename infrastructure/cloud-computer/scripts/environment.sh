...
echo export CLOUD_COMPUTER_CLOUD_PROVIDER_PROJECT=

echo export CLOUD_COMPUTER_CLOUDFLARE_EMAIL=
echo export CLOUD_COMPUTER_CLOUDFLARE_TOKEN=
echo export CLOUD_COMPUTER_CLOUDFLARE_ZONE=
...
echo export CLOUD_COMPUTER_DOMAIN_NAME=${CLOUD_COMPUTER_DOMAIN_NAME-cloud-computer.dev}
...
echo export CLOUD_COMPUTER_DOCKER=/cloud-computer/docker
echo export CLOUD_COMPUTER_FRONTEND=/cloud-computer/frontend
echo export CLOUD_COMPUTER_GCLOUD=/cloud-computer/gcloud
...
echo export CLOUD_COMPUTER_CERTIFICATES_VOLUME="${COMPOSE_PROJECT_NAME}_CLOUD_COMPUTER_CERTIFICATES"
...
echo export CLOUD_COMPUTER_DOCKER_VOLUME="${COMPOSE_PROJECT_NAME}_CLOUD_COMPUTER_DOCKER"
echo export CLOUD_COMPUTER_FRONTEND_VOLUME="${COMPOSE_PROJECT_NAME}_CLOUD_COMPUTER_FRONTEND"
echo export CLOUD_COMPUTER_GCLOUD_VOLUME="${COMPOSE_PROJECT_NAME}_CLOUD_COMPUTER_GCLOUD"
